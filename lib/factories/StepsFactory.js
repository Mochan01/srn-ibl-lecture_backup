...
export class StepsFactory {
    ...
    static getNextStepData(slide, step) {
        const stepData = this.getStepBySlide(slide);
        let { next_steps } = stepData[step];
        // スライドが終わりだったとき
     ...
     * @returns
     */
    static getSeekBarStartsBySlide(slide) {

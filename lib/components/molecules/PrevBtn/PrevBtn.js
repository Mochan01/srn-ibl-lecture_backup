...
export const PrevBtn = ({}) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("link", { rel: "preload", href: MINI_BUTTON_MUTATIONS.PREV_ON, as: "image" }),
        React.createElement("link", { rel: "preload", href: MINI_BUTTON_MUTATIONS.PREV_OFF, as: "image" }),

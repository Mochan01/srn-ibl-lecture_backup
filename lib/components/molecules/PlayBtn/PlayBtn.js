...
export const PlayBtn = ({ isPlay = false, onClick = () => { } }) => {
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("link", { rel: "preload", href: MINI_BUTTON_MUTATIONS.PAUSE_ON, as: "image" }),
        React.createElement("link", { rel: "preload", href: MINI_BUTTON_MUTATIONS.PAUSE_OFF, as: "image" }),
        React.createElement(MiniBtn, { onClick: onClick, caption: !isPlay ? "再生" : "一時停止", mutation: !isPlay
                ? MINI_BUTTON_MUTATIONS.PLAY_ON
                : MINI_BUTTON_MUTATIONS.PAUSE_ON, hoverMutation: !isPlay

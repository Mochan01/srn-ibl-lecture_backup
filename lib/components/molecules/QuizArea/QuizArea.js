...
const AnswerBtnWrapper = styled.div `
  ...
  `}
`;
export const QuizArea = ({ questions, correctIndex, x = 0, y = 0, width = SIZE.QUIZ_Q_BTN_W * 2 + SIZE.QUIZ_COLUMN_G, height = SIZE.QUIZ_Q_BTN_H * 2 + SIZE.QUIZ_ROW_G * 2 + SIZE.QUIZ_A_BTN_H }) => {
    // 選択ボタン 状態管理
    ...
    return (React.createElement(Main, Object.assign({ touchedEnable: !isAnswered, width: calcRatio(412, width), height: calcRatio(210, height) }, { x, y }),

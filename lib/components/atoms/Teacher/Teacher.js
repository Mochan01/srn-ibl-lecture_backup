...
`;
export const Teacher = ({ animation = "animation_1", className }) => {
    return (React.createElement(React.Fragment, null,
        Object.keys(TEACHER).map(key => (React.createElement("link", { key: key, rel: "preload", href: TEACHER[key], as: "image" }))),

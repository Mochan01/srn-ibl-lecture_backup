...
export const QUIZ_ANSWER_BTN = {
    GRAY: new URL("../../../assets/prod/Answer_button_greyout.png", import.meta.url).toString(),
    RED: new URL("../../../assets/prod/Answer_button_select.png", import.meta.url).toString(),
    WHITE: new URL("../../../assets/prod/Answer_button.png", import.meta.url).toString()
};

...
const lecture_title_base = new URL("../../../assets/prod/lecture_title_base.png", import.meta.url).toString();
const lecture_button_start = new URL("../../../assets/prod/lecture_button_start.png", import.meta.url).toString();
...
const StartBtn = styled.div `
  ...
  cursor: pointer;
`;
export const TitleBase = ({ unitName, unitTitle, onClick, className }) => {

...
const Correct = new URL("../../../assets/Correct.png", import.meta.url).toString();
const Wrong = new URL("../../../assets/Wrong.png", import.meta.url).toString();
...
export const QuizChoiceBtn = ({ mutation, children, isCorrect, onClick = () => { } }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Main, { role: "button", mutation: mutation, isCorrect: isCorrect, onClick: onClick },
            React.createElement(Comment, { color: color }, children))));
};

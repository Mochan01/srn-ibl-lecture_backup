 ...
 * @returns
 */
export const SeekBar = ({ value, setValue, className, onPointerDown = () => { }, onPointerUp = () => { } }) => {
    return (React.createElement(StyledSlider, Object.assign({ max: 100, value: [value], onValueChange: nextValue => setValue(nextValue[0]), onPointerDown: () => onPointerDown(value), onPointerUp: () => onPointerUp(value) }, { className }),

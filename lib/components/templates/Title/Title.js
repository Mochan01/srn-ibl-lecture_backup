    ...
    return React.createElement(React.Fragment, null,
        ...
        React.createElement(ScaleWrapper, null,
            React.createElement(Main, null,
                React.createElement(_PresentedBy, null),
                React.createElement(_CloseBtn, { onClick: onClickClose }),
                React.createElement(Cast, { teacher: isPlay ? step.teacher : "animation_1", student: step.student, css: css `
            position: absolute;
            top: 50%;
            right: 90px;
            transform: translateY(-50%);
          ` }, step.speech),
                React.createElement(TitleBase, Object.assign({ css: css `
            position: absolute;
            top: 0;
            left: 0;
            bottom: 0;
            right: 0;
            margin: auto;
          `, onClickStart: () => setIsPlay(true) }, { unitName, unitTitle, onClickSkip })))));
};

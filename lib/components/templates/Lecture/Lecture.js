...
import { LectureFrame } from "../../atoms/LectureFrame/LectureFrame";
...
const _CloseBtn = styled(CloseBtn) `
  ...
  right: 62px;
`;
const Main = ({ unitName, unitTitle, onClickClose = () => { }, onClickPrev = () => { }, }) => {
    ...
    return (React.createElement(ScaleWrapper, null,
        React.createElement(Container, null,
            ...
            React.createElement(LectureContents, null,
                React.createElement(LectureFrame, Object.assign({}, { unitName, unitTitle }),
                ...
                React.createElement(ControlPanel, Object.assign({}, { onClickPrev }))))));
};
/**
 *　先生と生徒
 */
const CastMemo = memo(({}) => {
    ...
    return (React.createElement(Cast, { teacher: isRunSeek ? currentStep.teacher : "animation_1", student: currentStep.student, css: css `
        position: absolute;
        top: 50%;
        right: 0px;

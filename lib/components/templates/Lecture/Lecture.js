...
const Main = ({ unitName, unitTitle, onClickClose = () => { } }) => {
    ...
    return (React.createElement(Container, { scale: scale },
        React.createElement("div", { style: {
            ...
            React.createElement(CastWrapper, null,
                React.createElement(Cast, { teacher: stepList[currentProgress].teacher, student: stepList[currentProgress].student }, stepList[currentProgress].speech)),

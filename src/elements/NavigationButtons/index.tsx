  ...
  return (
    <Main>
      {missionSelect.m_btn_1 && missionSelect.m_btn_1_goto && (
        <NavigationButton
          image={assetsPath[missionSelect.m_btn_1]}
      ...
      {missionSelect.m_btn_2 && missionSelect.m_btn_2_goto && (
        <>
          <Spacer size={64} />
          <NavigationButton
            image={assetsPath[missionSelect.m_btn_2]}
      ...
      {missionSelect.m_btn_3 && missionSelect.m_btn_3_goto && (
        <>
          <Spacer size={64} />
          <NavigationButton
            image={assetsPath[missionSelect.m_btn_3]}
      ...
      {missionSelect.m_btn_4 && missionSelect.m_btn_4_goto && (
        <>
          <Spacer size={64} />
          <NavigationButton
            image={assetsPath[missionSelect.m_btn_4]}
      ...
      {missionSelect.m_btn_5 && missionSelect.m_btn_5_goto && (
        <>
          <Spacer size={64} />
          <NavigationButton
            image={assetsPath[missionSelect.m_btn_5]}
